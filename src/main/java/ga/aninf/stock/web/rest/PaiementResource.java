...
import ga.aninf.stock.service.PaiementQueryService;
...
/**
 * REST controller for managing {@link ga.aninf.stock.domain.Paiement}.
 */
@RestController
...
public class PaiementResource {
     ...
     */
    @GetMapping("/{id}")
    public ResponseEntity<PaiementDTO> getPaiement(@PathVariable("id") UUID id) {
     ...
     */
    @DeleteMapping("/{id}")
    public ResponseEntity<Void> deletePaiement(@PathVariable("id") UUID id) {
