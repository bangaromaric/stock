...
public class Vente implements Serializable {
    ...
    @NotNull
    @Column(name = "vente_date", nullable = false)
    ...
    public Vente quantite(Long quantite) {
    ...
    public Vente venteDate(Instant venteDate) {
        this.setVenteDate(venteDate);
        return this;
    }
    ...
    public Vente deleteAt(Instant deleteAt) {
    ...
    public Vente createdBy(String createdBy) {
    ...
    public Vente createdDate(Instant createdDate) {
    ...
    public Vente lastModifiedBy(String lastModifiedBy) {
    ...
    public Vente lastModifiedDate(Instant lastModifiedDate) {
    ...
    public Vente structure(Structure structure) {
