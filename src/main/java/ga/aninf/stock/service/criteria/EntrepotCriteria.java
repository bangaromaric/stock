...
/**
 * Criteria class for the {@link ga.aninf.stock.domain.Entrepot} entity. This class is used
 * in {@link ga.aninf.stock.web.rest.EntrepotResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /entrepots?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class EntrepotCriteria implements Serializable, Criteria {
    ...
    public EntrepotCriteria() {}

    public EntrepotCriteria(EntrepotCriteria other) {
    ...
    @Override
    public EntrepotCriteria copy() {
        return new EntrepotCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final EntrepotCriteria that = (EntrepotCriteria) o;
        return (
