...
/**
 * Criteria class for the {@link ga.aninf.stock.domain.Categorie} entity. This class is used
 * in {@link ga.aninf.stock.web.rest.CategorieResource} to receive all the possible filtering options from
...
public class CategorieCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, libelle, deleteAt, createdBy, createdDate, lastModifiedBy, lastModifiedDate, produitId, distinct);
    }
