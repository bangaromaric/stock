...
export class AbonnementComponent implements OnInit {
  ...
  trackId = (_index: number, item: IAbonnement): string => this.abonnementService.getAbonnementIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.abonnements = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IAbonnement[] | null): IAbonnement[] {
    return data ?? [];
  }
