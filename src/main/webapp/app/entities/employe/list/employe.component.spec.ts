...
import { sampleWithRequiredData } from '../employe.test-samples';
...
describe('Employe Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'employe', component: EmployeComponent }]),
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.employes?.[0]).toEqual(expect.objectContaining({ id: '9fec3727-3421-4967-b213-ba36557ca194' }));
  });
