...
import { EntityArrayResponseType, EmployeService } from '../service/employe.service';
...
export class EmployeComponent implements OnInit {
  ...
  trackId = (_index: number, item: IEmploye): string => this.employeService.getEmployeIdentifier(item);
  ...
  protected fillComponentAttributesFromResponseBody(data: IEmploye[] | null): IEmploye[] {
    return data ?? [];
  }
