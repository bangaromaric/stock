...
import { EntityArrayResponseType, InventaireService } from '../service/inventaire.service';
...
export class InventaireComponent implements OnInit {
  ...
  trackId = (_index: number, item: IInventaire): string => this.inventaireService.getInventaireIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.inventaires = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IInventaire[] | null): IInventaire[] {
    return data ?? [];
  }
  ...
  protected queryBackend(): Observable<EntityArrayResponseType> {
    ...
    return this.inventaireService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
