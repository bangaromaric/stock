...
import { sampleWithRequiredData } from '../inventaire.test-samples';
...
describe('Inventaire Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'inventaire', component: InventaireComponent }]),
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.inventaires?.[0]).toEqual(expect.objectContaining({ id: '9fec3727-3421-4967-b213-ba36557ca194' }));
  });

  describe('trackId', () => {
    it('Should forward to inventaireService', () => {
      const entity = { id: '9fec3727-3421-4967-b213-ba36557ca194' };
      jest.spyOn(service, 'getInventaireIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getInventaireIdentifier).toHaveBeenCalledWith(entity);
