...
export const sampleWithRequiredData: IInventaire = {
  ...
  quantite: 4446,
  inventaireDate: dayjs('2024-03-29T17:47'),
...
export const sampleWithPartialData: IInventaire = {
  ...
  quantite: 30257,
  inventaireDate: dayjs('2024-03-29T21:46'),
  deleteAt: dayjs('2024-03-30T11:11'),
  createdBy: 'lors',
...
export const sampleWithFullData: IInventaire = {
  ...
  quantite: 15389,
  inventaireDate: dayjs('2024-03-29T20:45'),
  deleteAt: dayjs('2024-03-30T03:50'),
  createdBy: 'tant que du fait que',
  createdDate: dayjs('2024-03-30T10:19'),
  lastModifiedBy: 'ronron imposer',
  lastModifiedDate: dayjs('2024-03-29T21:02'),
};

export const sampleWithNewData: NewInventaire = {
  quantite: 26234,
  inventaireDate: dayjs('2024-03-30T10:57'),
