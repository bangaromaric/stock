...
import { sampleWithRequiredData } from '../vente.test-samples';
...
describe('Vente Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'vente', component: VenteComponent }]), HttpClientTestingModule, VenteComponent],
      providers: [
        {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.ventes?.[0]).toEqual(expect.objectContaining({ id: '9fec3727-3421-4967-b213-ba36557ca194' }));
  });
