...
import { EntityArrayResponseType, VenteService } from '../service/vente.service';
...
export class VenteComponent implements OnInit {
  ...
  trackId = (_index: number, item: IVente): string => this.venteService.getVenteIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.ventes = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IVente[] | null): IVente[] {
    return data ?? [];
  }
  ...
  protected queryBackend(): Observable<EntityArrayResponseType> {
    ...
    return this.venteService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
