...
import venteResolve from './vente-routing-resolve.service';
  ...
  describe('resolve', () => {
    it('should return IVente returned by find', () => {
      ...
      TestBed.runInInjectionContext(() => {
        venteResolve(mockActivatedRouteSnapshot).subscribe({
          next(result) {
            resultVente = result;
          },
        });
      ...
      expect(resultVente).toEqual({ id: '9fec3727-3421-4967-b213-ba36557ca194' });
    });
