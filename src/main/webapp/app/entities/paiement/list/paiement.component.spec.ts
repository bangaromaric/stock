...
import { sampleWithRequiredData } from '../paiement.test-samples';
...
describe('Paiement Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'paiement', component: PaiementComponent }]),
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.paiements?.[0]).toEqual(expect.objectContaining({ id: '9fec3727-3421-4967-b213-ba36557ca194' }));
  });
