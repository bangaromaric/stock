...
import { EntityArrayResponseType, CategorieService } from '../service/categorie.service';
...
export class CategorieComponent implements OnInit {
  ...
  trackId = (_index: number, item: ICategorie): string => this.categorieService.getCategorieIdentifier(item);
  ...
  protected fillComponentAttributesFromResponseBody(data: ICategorie[] | null): ICategorie[] {
    return data ?? [];
  }
  ...
  protected queryBackend(): Observable<EntityArrayResponseType> {
    ...
    return this.categorieService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
