...
import { sampleWithRequiredData } from '../categorie.test-samples';
...
describe('Categorie Management Component', () => {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.categories?.[0]).toEqual(expect.objectContaining({ id: '9fec3727-3421-4967-b213-ba36557ca194' }));
  });
