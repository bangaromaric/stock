...
describe('Categorie Management Detail Component', () => {
          ...
          [
            {
              ...
              resolve: { categorie: () => of({ id: '9fec3727-3421-4967-b213-ba36557ca194' }) },
            },
          ],
  ...
  describe('OnInit', () => {
    it('Should load categorie on init', async () => {
      ...
      // THEN
      expect(instance.categorie).toEqual(expect.objectContaining({ id: '9fec3727-3421-4967-b213-ba36557ca194' }));
    });
  });
