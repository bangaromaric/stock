...
import { sampleWithRequiredData } from '../structure.test-samples';
...
describe('Structure Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'structure', component: StructureComponent }]),
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.structures?.[0]).toEqual(expect.objectContaining({ id: '9fec3727-3421-4967-b213-ba36557ca194' }));
  });
