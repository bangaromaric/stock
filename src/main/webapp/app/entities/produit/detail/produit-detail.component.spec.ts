...
describe('Produit Management Detail Component', () => {
          ...
          [
            {
              ...
              resolve: { produit: () => of({ id: '9fec3727-3421-4967-b213-ba36557ca194' }) },
            },
          ],
  ...
  describe('OnInit', () => {
    it('Should load produit on init', async () => {
      ...
      // THEN
      expect(instance.produit).toEqual(expect.objectContaining({ id: '9fec3727-3421-4967-b213-ba36557ca194' }));
    });
  });
