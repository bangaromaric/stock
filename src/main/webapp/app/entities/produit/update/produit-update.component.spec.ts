...
describe('Produit Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Categorie query and add missing value', () => {
      const produit: IProduit = { id: '1361f429-3817-4123-8ee3-fdf8943310b2' };
      const categorie: ICategorie = { id: '6e2b0188-7f40-421c-adc3-9cf0e95bab8e' };
      produit.categorie = categorie;

      const categorieCollection: ICategorie[] = [{ id: 'feaad231-f32b-432e-b613-d89a177e5779' }];
    ...
    it('Should update editForm', () => {
      const produit: IProduit = { id: '1361f429-3817-4123-8ee3-fdf8943310b2' };
      const categorie: ICategorie = { id: '0b77edf3-412f-4b64-9612-aa690b71f5b1' };
      produit.categorie = categorie;
  ...
  describe('save', () => {
    it('Should call update service on save for existing entity', () => {
      ...
      const produit = { id: '9fec3727-3421-4967-b213-ba36557ca194' };
