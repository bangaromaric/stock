...
describe('Permission Management Detail Component', () => {
          ...
          [
            {
              ...
              resolve: { permission: () => of({ id: '9fec3727-3421-4967-b213-ba36557ca194' }) },
            },
          ],
  ...
  describe('OnInit', () => {
    it('Should load permission on init', async () => {
      ...
      // THEN
      expect(instance.permission).toEqual(expect.objectContaining({ id: '9fec3727-3421-4967-b213-ba36557ca194' }));
    });
  });
