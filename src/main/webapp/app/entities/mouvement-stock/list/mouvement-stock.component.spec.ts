...
import { sampleWithRequiredData } from '../mouvement-stock.test-samples';
...
describe('MouvementStock Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'mouvement-stock', component: MouvementStockComponent }]),
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.mouvementStocks?.[0]).toEqual(expect.objectContaining({ id: '9fec3727-3421-4967-b213-ba36557ca194' }));
  });

  describe('trackId', () => {
    it('Should forward to mouvementStockService', () => {
      const entity = { id: '9fec3727-3421-4967-b213-ba36557ca194' };
      jest.spyOn(service, 'getMouvementStockIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getMouvementStockIdentifier).toHaveBeenCalledWith(entity);
