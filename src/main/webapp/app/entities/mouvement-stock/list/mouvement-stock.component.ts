...
import { EntityArrayResponseType, MouvementStockService } from '../service/mouvement-stock.service';
import { MouvementStockDeleteDialogComponent } from '../delete/mouvement-stock-delete-dialog.component';
...
export class MouvementStockComponent implements OnInit {
  ...
  trackId = (_index: number, item: IMouvementStock): string => this.mouvementStockService.getMouvementStockIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.mouvementStocks = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IMouvementStock[] | null): IMouvementStock[] {
    return data ?? [];
  }
  ...
  protected queryBackend(): Observable<EntityArrayResponseType> {
    ...
    return this.mouvementStockService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
