...
class MouvementStockCriteriaTest {
    ...
    void newMouvementStockCriteriaHasAllFiltersNullTest() {
        ...
        assertThat(mouvementStockCriteria).is(criteriaFiltersAre(filter -> filter == null));
    }
    ...
    private static void setAllFilters(MouvementStockCriteria mouvementStockCriteria) {
        ...
        mouvementStockCriteria.quantite();
        mouvementStockCriteria.typeMouvement();
        mouvementStockCriteria.transactionDate();
        mouvementStockCriteria.deleteAt();
        mouvementStockCriteria.createdBy();
        mouvementStockCriteria.createdDate();
        mouvementStockCriteria.lastModifiedBy();
        mouvementStockCriteria.lastModifiedDate();
        mouvementStockCriteria.produitId();
        mouvementStockCriteria.entrepotId();
